...
public class DocumentReader extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if(action.equals("initReader")){
            ...
            this.scanDocument();
            return true;
        } else if(action.equals("scenario")){
            String identifier = args.getString(0);
            this.setScenario(identifier);
            return true;
        }
        return false;
    }
    ...
    private void setScenario(String identifier){
        com.regula.documentreader.api.DocumentReader.Instance().processParams.scenario = identifier;
    }
