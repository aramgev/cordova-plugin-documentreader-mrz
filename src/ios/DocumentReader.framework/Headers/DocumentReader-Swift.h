...
@property (nonatomic, copy) NSString * _Nonnull databaseIdentificator;
@property (nonatomic) BOOL databaseAutoupdate;
...
typedef SWIFT_ENUM(NSInteger, DocReaderFrame, closed) {
  DocReaderFrameNotSelected = 0,
  DocReaderFrameId1 = 1,
  DocReaderFrameMax = 2,
  DocReaderFrameNone = 3,
};
...
@property (nonatomic, readonly, copy) NSString * _Nonnull docList;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
